...
contract StarNotary is ERC721 {
    ...
    constructor() public ERC721("StarNotary", "SNC") {}
...
/*    // Function that allows you to convert an address into a payable address
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        Star memory foundStar = tokenIdToStarInfo[_tokenId];
        string memory nameOfStar = foundStar.name;
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerAddressToken1 || msg.sender == ownerAddressToken2);

        //2. You don't have to check for the price of the token (star)
        //4. Use _transferFrom function to exchange the tokens.
        //Exchange Token 1
        transferFrom(ownerAddressToken1, ownerAddressToken2, _tokenId1);

        //Exchange Token 2
        transferFrom(ownerAddressToken2, ownerAddressToken1, _tokenId2);
    }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerAddressToken);
